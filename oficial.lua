...
-- ===========================================================
-- Abas (mesma estrutura lógica do original)
-- ===========================================================
local Tabs = {
    Main = Window:CreateTab{ Title = "Main", Icon = "home" },
    Player = Window:CreateTab{ Title = "Player / Stack", Icon = "user" },
    Raid = Window:CreateTab{ Title = "Raid / Boss", Icon = "swords" },
    Shop = Window:CreateTab{ Title = "Shop", Icon = "shopping-cart" },
    Misc = Window:CreateTab{ Title = "Misc", Icon = "settings" }
}

-- ===========================
-- Aba Main (antiga Tab1)
-- ===========================

-- Page1 (Label + Auto Farm Level)
Tabs.Main:CreateSection("Main")
Tabs.Main:CreateParagraph("MainTitle", {
    Title = "Main",
    Content = ""
})
Tabs.Main:CreateToggle("AutoFarmLevel", {
...
-- Page3 (Fast Attack, Fast Attack Type, Auto Haki, Select Weapon)
Tabs.Main:CreateSection("Combat")
Tabs.Main:CreateToggle("FastAttack", {
    Title = "Fast Attack",
...
Tabs.Main:CreateDropdown("FastAttackType", {
    Title = "Fast Attack Type",
    Values = {"Fast", "Normal", "Slow"},
    Multi = false,
    Default = _G.Settings.Configs["Fast Attack Type"][1] or "Fast",
    Callback = function(value)
        _G.Settings.Configs["Fast Attack Type"] = {value}
        SaveSettings()
    end
})
Tabs.Main:CreateToggle("AutoHaki", {
    Title = "Auto Haki",
...
Tabs.Main:CreateDropdown("SelectWeapon", {
    Title = "Select Weapon",
...
-- Coroutines e loops associados (mantidos na íntegra)
coroutine.wrap(function()
    -- (Fast Attack loop original)
end)()

spawn(function()
    -- (Auto Haki loop original)
end)

task.spawn(function()
    -- (Select Weapon loop original)
end)

spawn(function()
    -- (BodyVelocity/No Physics loop original)
end)

-- ===========================
-- Aba Player (antiga Tab2) – estrutura vazia por enquanto
-- ===========================
Tabs.Player:CreateSection("Player Page 1")
Tabs.Player:CreateSection("Player Page 2")
-- Adicione aqui os elementos da Page9 e Page15 quando precisar

-- ===========================
-- Aba Raid (antiga Tab3) – estrutura vazia
-- ===========================
Tabs.Raid:CreateSection("Raid Page 1")
Tabs.Raid:CreateSection("Raid Page 2")

-- ===========================
-- Aba Shop (antiga Tab4) – estrutura vazia
-- ===========================
Tabs.Shop:CreateSection("Shop Page 1")
Tabs.Shop:CreateSection("Shop Page 2")

-- ===========================
-- Aba Misc (antiga Tab5) – estrutura vazia
-- ===========================
Tabs.Misc:CreateSection("Misc Page 1")
Tabs.Misc:CreateSection("Misc Page 2")

-- ===========================================================
-- Configurações da Fluent (SaveManager, etc.)
-- ===========================================================
SaveManager:SetLibrary(Library)
InterfaceManager:SetLibrary(Library)
SaveManager:IgnoreThemeSettings()
SaveManager:SetIgnoreIndexes{}
InterfaceManager:SetFolder("SilverHub")
SaveManager:SetFolder("SilverHub/BloxFruits")

Library:Notify({
    Title = "Silver Hub Premium",
    Content = "Script convertido para Fluent Renewed! 💎",
    Duration = 5
})
